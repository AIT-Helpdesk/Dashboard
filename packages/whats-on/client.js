...
// needlessly" convention as lastTodayTomorrowData above, and exactly what
// "definitely don't [fetch] every time a user clicks" requires. null until
...
export function mount(container) {
  ...
  // blocking this page's own main load. A no-op once already cached from
  // an earlier mount this session.
